...
import { fetchTypeOrdonnances } from '../../Api/features/ordonnance/typeOrdonnanceThunk'; // Assurez-vous que le thunk est bien défini
              ...
              <TableRow key={i}>
                <TableCell>
                  <div className="flex items-center text-sm">
                    <div>
                      <p className="font-semibold">{type.id} </p>
                    </div>
                  </div>
                </TableCell>
                <TableCell>
