...
const DetailFactureExamen = (props) => {
        ...
        <div className="flex justify-between mb-10">
          ...
          <div className="w-1/2 text-right">
            ...
            <p className="text-gray-600">
              <strong>Nom :</strong> {facture.patient_detail.user_detail.first_name}{" "}
              {facture.patient_detail.user_detail.last_name}
            </p>
            <p className="text-gray-600">
              <strong>Email :</strong> {facture.patient_detail.user_detail.email}
            </p>
            <p className="text-gray-600">
              <strong>Date :</strong>{" "}
        ...
        {facture.examens && (
          <div>
            ...
            <table className="w-full mb-6 border border-collapse border-gray-300">
              ...
              <tbody>
                {facture.examens.map((detail, index) => (
                  <tr key={index} className="hover:bg-gray-100">
                    <td className="px-4 py-2 border border-gray-300">
                      {detail.type_examen_detail.nom}
                    </td>
                    <td className="px-4 py-2 text-center border border-gray-300">
                      1
                    </td>
                    <td className="px-4 py-2 text-right border border-gray-300">
                      {detail.type_examen_detail.prix} €
                    </td>
                    <td className="px-4 py-2 text-right border border-gray-300">
                      {detail.type_examen_detail.prix} €
                    </td>
...
export default DetailFactureExamen;
