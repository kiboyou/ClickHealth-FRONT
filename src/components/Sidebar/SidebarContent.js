            ...
            route.routes ? (
              ...
              <li className="relative px-6 py-3" key={route.name}>
                <NavLink
                  exact
                  to={route.path}
                  className="inline-flex items-center w-full mt-2 text-sm font-semibold transition-colors duration-150 focus:outline-none focus:border-none hover:text-gray-200"
